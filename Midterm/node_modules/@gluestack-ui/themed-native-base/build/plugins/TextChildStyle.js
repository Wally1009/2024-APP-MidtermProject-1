...
exports.TextStyleResolver = void 0;
    ...
    componentMiddleWare({ Component, GluestackStyleSheet }) {
        ...
        const TextStyledResolvedComponent = (0, react_1.forwardRef)((_a, ref) => {
            ...
            if (react_native_1.Platform.OS !== 'web') {
                ...
                componentProps['data-style'].split(' ').forEach((cssId) => {
                ...
                return (react_1.default.createElement(StyledComponent, Object.assign({}, componentProps, { sx: Object.assign(Object.assign({}, stylesObj), { props: { style: resolvedStyle } }), key: key + (0, utils_1.stableHash)(resolvedStyle), ref: ref }), children));
            }
            else {
                return (react_1.default.createElement(StyledComponent, Object.assign({}, componentProps, { ref: ref }), children));
            }
        });
        //@ts-ignore
