...
function Factory(Component, componentTheme) {
    const NewComponent = (0, react_2.styled)(Component, (0, NBsupport_1.transformFactoryToStyled)(componentTheme));
    const ComponentWrapper = (0, react_1.forwardRef)((_a, ref) => {
        var { children } = _a, props = __rest(_a, ["children"]);
        const resolvedProps = (0, usePropResolution_1.usePropResolution)(props);
        return (react_1.default.createElement(NewComponent, Object.assign({}, resolvedProps, { ref: ref }), children));
    });
