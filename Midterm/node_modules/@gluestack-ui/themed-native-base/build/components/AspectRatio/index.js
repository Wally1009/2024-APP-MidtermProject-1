...
const AspectRatioTemp = (0, react_1.forwardRef)((_a, ref) => {
    var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w;
    var { children, ratio } = _a, props = __rest(_a, ["children", "ratio"]);
    const resolvedPropForGluestack = (0, usePropResolution_1.usePropResolution)(props);
    const aspectRatio = (0, hooks_1.useBreakpointValue)(ratio);
    ...
    if (colorModeGradient) {
        ...
        if (Gradient) {
            ...
            return (react_1.default.createElement(styled_components_1.Root, Object.assign({ as: Gradient, aspectRatio: aspectRatio }, resolvedPropForGluestack, { colors: lgrad.colors, start: startObj, end: endObj, locations: lgrad.locations, ref: ref }), GUIChildren));
        }
    }
    return (react_1.default.createElement(styled_components_1.Root, Object.assign({ aspectRatio: aspectRatio }, resolvedPropForGluestack, { ref: ref }), GUIChildren));
});
exports.AspectRatio = AspectRatioTemp;
