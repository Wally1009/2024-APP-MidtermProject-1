...
const hstack_1 = require("@gluestack-ui/hstack");
...
const AccessibleHStack = (0, hstack_1.createHStack)({
    Root: styled_components_1.Root,
});
const HStackTemp = (0, react_1.forwardRef)((_a, ref) => {
    var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z;
    var { children, divider, direction } = _a, props = __rest(_a, ["children", "divider", "direction"]);
    props.flexDirection =
        (_d = (_c = (_b = props.flexDirection) !== null && _b !== void 0 ? _b : props.flexDir) !== null && _c !== void 0 ? _c : direction) !== null && _d !== void 0 ? _d : 'row';
    ...
    if (colorModeGradient) {
        ...
        if (Gradient) {
            ...
            return (react_1.default.createElement(AccessibleHStack, Object.assign({ as: Gradient }, resolvedPropForGluestack, { colors: lgrad.colors, start: startObj, end: endObj, locations: lgrad.locations, ref: ref }), react_1.Children.map(children, (child, index) => {
                if (index !== 0)
    ...
    return (react_1.default.createElement(AccessibleHStack, Object.assign({}, resolvedPropForGluestack, { ref: ref }), react_1.Children.map(children, (child, index) => {
        if (index !== 0)
            return (react_1.default.createElement(react_1.default.Fragment, null,
                divider &&
                    (0, react_1.cloneElement)(divider, {
