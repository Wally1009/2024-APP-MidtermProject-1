...
function useToast() {
    const toast = (0, toast_1.createToastHook)(styled_components_1.AnimationWrapper, animation_resolver_1.AnimatePresence)();
    ...
    const show = (_a) => {
        ...
        if (render)
            ...
            const ToastComp = ({ id }) => {
                return (react_1.default.createElement(__1.Toast, { sx: props, nativeID: id },
                    title && react_1.default.createElement(__1.Toast.Title, null, title),
                    description && (react_1.default.createElement(__1.Toast.Description, null, description))));
            };
            toast.show({
                duration,
                containerStyle: Object.assign({}, props),
