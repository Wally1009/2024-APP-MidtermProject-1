...
const Women_TshirtDetailScreen = ({ route }) => {
    ...
    const handleAddToCart = () => {
        addToCart({ title, money, key, descriptions, image: WomenTshirtimgs[key], type: 'WomenTshirt' });
...
export default Women_TshirtDetailScreen;
