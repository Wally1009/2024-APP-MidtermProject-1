...
const Women_JacketDetailScreen = ({ route }) => {
    ...
    const handleAddToCart = () => {
        addToCart({ title, money, key, descriptions, image: WomenJacketimgs[key], type: 'WomenJacket' });
...
export default Women_JacketDetailScreen;
