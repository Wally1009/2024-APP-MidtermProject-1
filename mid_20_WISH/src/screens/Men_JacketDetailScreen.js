...
const MenJacketimgs = [img0, img1, img2, img3, img4, img5];
const plusclothesicon = [img6, img7];

const Men_JacketDetailScreen = ({ route }) => {
    ...
    const handleAddToCart = () => {
        addToCart({ title, money, key, descriptions, image: MenJacketimgs[key], type: 'MenJacket' });
...
export default Men_JacketDetailScreen;
