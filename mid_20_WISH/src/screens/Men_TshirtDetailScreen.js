...
const MenTshirtimgs = [img0, img1, img2, img3, img4, img5];
const plusclothesicon = [img6, img7];

const Men_TshirtDetailScreen = ({ route }) => {
    ...
    const handleAddToCart = () => {
        addToCart({ title, money, key, descriptions, image: MenTshirtimgs[key], type: 'MenTshirt' });
...
export default Men_TshirtDetailScreen;
