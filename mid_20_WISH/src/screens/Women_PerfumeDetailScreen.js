...
const WomenPerfumeimgs = [img0, img1, img2, img3, img4, img5,img0, img1, img2, img3, img4, img5,img0, img1, img2, img3, img4, img5,img0, img1, img2, img3, img4, img5];
const plusclothesicon = [img6, img7];

const Women_PerfumeDetailScreen = ({ route }) => {
    ...
    const handleAddToCart = () => {
        addToCart({ title, money, key, descriptions, image: WomenPerfumeimgs[key], type: 'WomenPerfume' });
...
export default Women_PerfumeDetailScreen;
